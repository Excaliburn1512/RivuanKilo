...
// Import package utama saja
import 'package:weather_animation/weather_animation.dart';

class CustomWrapperScene extends StatelessWidget {
  const CustomWrapperScene({
    super.key,
  ...
  factory CustomWrapperScene.weather({
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      clipBehavior: clip,
      decoration: decoration,
      // PENGGANTI BackgroundWidget (Manual Container + Gradient)
      child: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: colors,
            begin: isLeftCornerGradient == true
                ? Alignment.topLeft
                : Alignment.topCenter,
            end: isLeftCornerGradient == true
