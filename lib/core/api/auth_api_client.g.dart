...
class _AuthApiClient implements AuthApiClient {
  ...
  Future<DeviceProvisionResponse> provisionDevice(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<DeviceProvisionResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeviceProvisionResponse _value;
    try {
      _value = DeviceProvisionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<SystemModel>> getMySystems() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<SystemModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<SystemModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => SystemModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<List<HistoryModel>> getHistoryLogs(String systemId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<HistoryModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
